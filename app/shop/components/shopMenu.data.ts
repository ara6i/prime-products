  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        href: "/pdp-studio",
        image:
          "/media/partner-landing/merchant-network/merchant-features/pdp-tryon-model.webp",
      },
      {
        label: "AI fitting",
        href: "/merchants/dashboard/integrations",
        image:
          "/media/partner-landing/merchant-tryon-ai-sizing-mobile-static-4k.webp",
      },
    ],
  },
  {
    ...
    features: [
      {
        label: "Supply the network",
        href: "/suppliers",
        image: "/media/partner-landing/supplier/supplier-merchant-hero.png",
      },
      {
    ...
    features: [
      {
        ...
        image: "/images/pdp-studio/ai-tools-v2/edit-with-ai.webp",
      },
      {
        label: "Photoshoot",
        href: "/pdp-studio/clothing-photoshoot",
        image: "/images/pdp-studio/ai-tools-v2/ai-fashion-models.webp",
      },
      {
        label: "Templates",
        href: "/pdp-studio/templates",
        image: "/images/pdp-studio/ai-tools-v2/product-staging.webp",
      },
      {
        label: "Batch edit",
        href: "/pdp-studio/batch",
        image: "/images/pdp-studio/ai-tools-v2/batch.webp",
      },
    ],
  },
  {
    ...
    features: [
      {
        label: "AI sizing",
        href: "/#features",
        image: "/images/landing/ps/ps-raw-01-sizing.jpg",
      },
      {
        label: "Virtual try-on",
        href: "/demo/products",
        image: "/images/landing/ps/ps-raw-06-tryon.jpg",
      },
      {
        label: "The SDK",
        href: "/customer/dashboard/docs",

...
export const docsNavigation: NavSection[] = [
  ...
  },
  {
    ...
    icon: Code2,
    children: [
      { id: "api-tryon-create", title: "POST /api/v1/tryon", parentId: "api-reference" },
      { id: "api-tryon-status", title: "GET /api/v1/tryon/status/:id", parentId: "api-reference" },
      { id: "api-tryon-stream", title: "SSE Stream", parentId: "api-reference" },
      { id: "api-upload", title: "Upload Image", parentId: "api-reference" },
      { id: "api-sizing-recommend", title: "POST /api/v1/sizing/recommend", parentId: "api-reference" },
      { id: "api-sizing-sizeguide", title: "POST /api/v1/sizing/sizeguide", parentId: "api-reference" },

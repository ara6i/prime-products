  ...
  "inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost: "bg-transparent rounded-[1.042vw] hover:bg-surface-light",
        link: "bg-transparent text-brand-blue rounded-[52.083vw] hover:bg-brand-blue-pale",
        outline:
          "bg-transparent border border-[#2154EF] text-[#2154EF] rounded-[52.083vw] hover:bg-brand-blue-pale",
        chip: "bg-[#D1D1D1] text-[#4F4F4F] rounded-[52.083vw] data-[active=true]:bg-[#5D5D5D] data-[active=true]:text-white",
        secondary:
        ...
        commerce:
          "bg-shop-pdp-ink text-[color:var(--shop-pdp-paper)] rounded-shop-pdp-control hover:bg-shop-pdp-ink-soft",
        "commerce-outline":
          "border border-shop-pdp-ink bg-shop-pdp-paper text-shop-pdp-ink rounded-shop-pdp-control hover:bg-shop-pdp-surface",
      },
      size: {
        default:
          "h-[2.604vw] px-[0.833vw] py-[0.625vw] gap-[0.313vw] text-[0.833vw] leading-[1.625]",
        ...
        "2xl":
          "h-[3.021vw] px-[1.25vw] py-[0.833vw] gap-[0.417vw] text-[0.833vw] leading-[1.625]",
        commerce:
          "h-shop-pdp-control px-shop-pdp-action-x gap-[0.521vw] text-[length:var(--shop-pdp-text-action)] font-semibold uppercase tracking-[0.08em]",
      },
    },
    defaultVariants: {
      variant: "primary",

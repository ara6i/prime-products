...
function MobileStepCard({ step, aiTag }: { step: SdkStep; aiTag?: string }) {
  return (
    <Reveal className="flex min-w-0 flex-col gap-4">
      <div className="relative aspect-[4/5] w-full max-w-full overflow-hidden rounded-2xl border border-text-primary/8 bg-white shadow-[0_8px_24px_rgba(0,0,0,0.08)]">

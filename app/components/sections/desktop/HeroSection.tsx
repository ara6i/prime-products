    ...
    <section className="relative isolate overflow-hidden border-b border-brand-blue/10 bg-white px-1 pb-5 pt-4 lg:px-[3.125vw] lg:pb-[2.4vw] lg:pt-[2.2vw]">
      ...
      <div className="relative z-10 grid grid-cols-1 gap-4 pt-3 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-[4.25vw] lg:pt-[2.3vw]">
        <div className="min-w-0">
          ...
          <Reveal delay={1}>
            <h1 className="ps-hero-title mt-4 hidden w-full max-w-none font-poppins font-medium text-text-primary lg:mt-[1.45vw] lg:block lg:max-w-[41vw] lg:text-[clamp(3.35rem,4.8vw,6.15rem)] lg:leading-[1.02] lg:tracking-[-0.052em]">
...
function HeroTechStack() {
  return (
    <div className="grid grid-cols-2 gap-[0.6vw]">
      <div className="flex min-w-[8.2vw] flex-col gap-[0.34vw] rounded-[0.95vw] border border-brand-blue/15 bg-white px-[0.85vw] py-[0.68vw] text-brand-blue shadow-[0_14px_32px_rgba(33,84,239,0.09)]">
        ...
        <span className="text-[0.58vw] font-medium leading-[1.2] tracking-normal text-text-body">
          Coming soon
        </span>
      </div>

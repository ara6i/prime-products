...
const HERO_STEPS = [
  { number: "01", title: "Choose it", body: "Pick approved products and see the current rate." },
  { number: "02", title: "Share it", body: "Publish your tracked, shoppable creator link." },
  { number: "03", title: "Try it. Buy it.", body: "We help your audience purchase with confidence using virtual try-on and our AI size recommender." },
    ...
    <div className={styles.heroJourney}>
      <div className={styles.heroSteps}>
        ...
        <article className={styles.heroStep}>
          ...
          <div className={styles.shareProof}>
            <div className={styles.creatorPhone}>
              <Image src={CREATOR_IMAGE} alt="Creator publishing her shoppable look" fill sizes="180px" />
        ...
        <article className={styles.heroStep}>
          ...
          <div className={styles.shopProof}>
            <Image src={CREATOR_IMAGE} alt="Shopper-ready creator look" fill sizes="320px" />
            <span><CheckCircle size={14} weight="fill" /> Size M · in stock</span>
            <strong><ShoppingBagOpen size={19} weight="bold" /> Shop on merchant site</strong>
          </div>
        </article>
